...
var graphicAssets = {
    tiles: [{URL: 'assets/forest.png', name:'forest', income:30}, {URL:'assets/lake.png', name:'lake', income:20}, {URL:'assets/mountain.png', name:'mountain', income:10}],
    ...
    buildBunker: function () {
     ...
     spawnTerrain: function () {
        ...
        for (var i = 0; i <= 10; i++) {
            ...
            if (game.physics.arcade.overlap(terrainSprite, terrainGroup) || game.physics.arcade.overlap(terrainSprite, this.bunker)) {//Checks if the attempted terrain sprite overlaps with any existing sprite
                i -= 1;
