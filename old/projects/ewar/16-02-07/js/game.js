...
var graphicAssets = {
    ...
    moveAttackButton: {URL: 'assets/moveAttackButton.png', name:'moveAttackButton', width: 30, height: 30},
};
...
gameState.prototype = {
    ...
    preload: function () {
        ...
        game.load.spritesheet(graphicAssets.moveAttackButton.name, graphicAssets.moveAttackButton.URL, graphicAssets.moveAttackButton.width, graphicAssets.moveAttackButton.height);
     },
    ...
    infoDraw: function () {
    	...
    	//Actionmenu Init
    	moveAttackButton = game.add.button(game.width - 200, 11, 'moveAttackButton', this.moveAttackButtonClick, this, 0)
    },

    moveAttackButtonToggle: function () {
        if (!Square.actionMenuMoveAttack){
            console.log('Move or attack');
            Square.actionMenuMoveAttack = true
            moveAttackButton.setFrames(1, 1, 1, 1)
        } else {
            console.log('Cancel move or attack');
            Square.actionMenuMoveAttack = false
            moveAttackButton.setFrames(0, 0, 0, 0)
        }
    },
    moveAttackButtonClick: function () {
        this.moveAttackButtonToggle()
